...
const Navbar = () => {
    ...
    const links = <>
        ...
        <li><Link href="/alumni" className={pathname === "/alumni" ? 'active btn btn-success text-white rounded-2xl' : ''} >Alumni Directory</Link></li>
    ...
    return (
        <nav className="fixed top-0 left-0 z-50 w-full bg-linear-to-r from-green-200 to-green-100 shadow-sm flex items-center">
